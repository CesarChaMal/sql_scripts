...
q='>';zg=zCn=zSbL=zAc=zGARF=zDMN=zPxzTL=0;z0=zpT=zast=zChA=zAds=zKW='';d=document;zDL=new Date();zOr=(this.zOrO?(zr(99999)+zr(99999)):zOr)+zr(99999);zAUC=zBb=zBbo=zBbS0=zTbC=0;zBbS1=1
...
if(zRf==''){zRf=(zR.indexOf(uy)>-1)?0:(zR==''?-2:-1);for(var i=0;i<zRA.length;)if(zR.indexOf(zRA[i++]+'.')>-1)zRf=i;if(this.zRQO&&zRQ.length){i=zRQ.indexOf('&q=');if(i<0)i=zRQ.indexOf('?q=');if(i<0)i=zRQ.indexOf('?p=');if(i>0){zRQ=zrp(zRQ.substring(i+3),'+',' ');i=zRQ.indexOf('&');if(i>0)zRQ=zRQ.substring(0,i);zKW=es(zRQ,'kw=')}}}
zc(5,'zRf',zRf,30,'');
...
zOHA=new Array("arts","Arts & Literature","autos","Automotive","business","Business","citiestowns","Cities & Towns","compute","Computing & Technology","education","Education","entertainment","Entertainment","gadgets","Electronics & Gadgets","food","Food & Drink","health","Health & Fitness","hobbies","Hobbies & Games","homegarden","Home & Garden","homework","Homework Help","careers","Jobs & Careers","money","Money","newsissues","News & Issues","parenting","Parenting & Family","people","People & Relations","religion","Religion & Spirituality","shopping","Shopping","sports","Sports & Recreation","style","Style","teens","Teens","travel","Travel")
...
zbC=n+zbVi
if(window.attachEvent)window.attachEvent("onunload",zFUC)
...
if(this.zGRCn){}else
google_ad_channel=(this.zGRC&&zGRC.length?zGRC:('primedia_'+gs+((zG&8)&&this.zGOP?'_offers':'')))+(this.zTt&&!this.zTtO?' tt'+zTt+(zNL&&(zTt=='23')?' test5':''):'')+(this.zGCID?zGCID:'')+zST(2,' test')+(this.zGtKw?' test'+zBTS:'')
google_ad_output='js'
...
var n,mB,bH=p<0,bT=this.zDc,td=zdn.length?zdn:dn,tm=zcs==''?'':';sbj='+zcs,s='',e=o=='1'?'':o,a='',m=0,ax,d=g+'x'+h,v=ze(';'+e+g+''+h+'=',zz),l=v.length,b=0,e=0,t=0,q=100
if(bH)p=-p;if(!l){v=zx;l=v.length}
if(l>4){t=1*v.charAt(0);b=1*v.substring(1,3);e=1*v.substring(3,5);if(l>7)q=1*v.substring(6,8)}
ztm0((this.zDO?'N479':'')+'ad.doubleclick.net');if(!m&&zr(100)>q){m=1;t=1*v.substring(5,6)};if((g==728)&&(this.f728)){t=f728;m=1}
if(m){if(t==2)return;if(t==3)return;if(t==4&&zAu(zhc,'hc',-1,g,h))return 1}
if(o.length>1){o=s[0];s=substring(1)}
if((g==336)&&this.zFHP){h=600;d=g+'x'+h}
mB=(!this.zD336||zD336==1)&&(g==336)&&(h==280)?3:1;ax='/'+bp+((td==uy)&&c.length?'abt.'+c:td)+'/'+c+'_'+gs+';'+zap+'svc='+s+';site='+(zgs.length?zgs:gs)+';t='+zTa+';bt='+zBT+';bts='+zBTS+zST(2,';st=')+((zDot==3)&&zbDM?zDMD():'')+';pc='+zpc+';auc='+(++zAUC)+';fd='+zFDT+';fs='+zFST+(this.zir?';r='+zir:'')+';sp2='+(zbXP2?1:0)+(zs>0?';go='+zGSk:'')+';a='+zc(0,'aut=')+tm+';kw='+k+';chan='+c+';syn=about;tile='+p+(mB==3?';af=0':'')+';r='+zRf+(bT?';dcopt=ist':'')+';sz='+d+';u='+zOr+';dc_ref='+escape(zWl)+';ord='+(bH?'1':o)+zOr
if((g==468)||(g==728))zGSk+=4;if(bT)zDc=0;if(o=='8')return zas+'/adx'+ax
zau(zbDM&&(g==160||g==728||((g==336)&&(h=280)))?32769:1,g,h,sn,zas,ax,mB)}
...
else {if(24576&f){a=zChA+n+r+f+r;zChA=a} x=d+(f&1?'/adi':z)+u;if((m&1)&&this.zTAU){x=zTAU(g,h,x)}else if((f&32768)&&zbDM&&(zDot!=3)){x="http://usadmm.dotomi.com/dmm/servlet/dmm?rurl="+escape(x).replace(new RegExp('\\+','g'),'%2B')+"&pid=10400&dres=iframe&mtg=0&ms="+(g==160?21:(g==336?11:18))+"&btg=1&mp=1&rwidth="+g+"&rheight="+h}
...
function zac(a,k,b,d,c,g,o){if(zAc)return;zAc=1;if(window.captureEvents){window.captureEvents(Event.CLICK);window.onclick=zTi}else document.onclick=zTi;if(window.captureEvents){window.captureEvents(Event.UNLOAD);window.onunload=zTu}else window.onunload=zTu;if(zBb)zBB();if(this.zBbO)zLP(0,zBbO);var z=zBBaf(),B=new zTb(),l,r,s,t,u;zin();if(zast)while(zast.length){s=pl();t=pl();r=pl();u=pl();wcl(s,t,r,u)}
...
if(1==zr(100))zau(256,1,1,'px3',zh+'0.tqn.com/px/?p=ggl'+zs+(zG&16?'p':'b')+zTa+'_'+(this.zLb?zLb:0)+(this.zGCID?'&ggt='+zE(zGCID):'')+'&w='+zIfw+'&gs='+gs+'&tt='+zTa+'&bt='+zBT+'&bts='+zBTS+zST(2,'&st=')+'&bbaf='+z+'&a='+(zAC?1:0)+zSm+(zSu.length?'&su='+zSu:''),'')}
...
function zGARD(){var a=this.zRad,b=a?(zOfsL>=0):1;if(b&&(zs>=0)&&(zGARF<1)){zGARF=1;if(100>zr(1000))zPxT('gard=1&gs='+gs+'&c='+zs+(a?'&r='+zOfsL:'')+'&tt='+zTa+'&bt='+zBT+'&bts='+zBTS+zST(2,'&st='))
}}
...
zSbL=i;w(x6)}
function zSae(n,d,i,u,t,r,b){var f=this.zGRH,x=xf+x1,y=x1+'>';w('<p onMouseOver="return zhl(1,'+n+')" onMouseOut="zhl(0)">'+x2+u+(f?x1+qf+'"t':'')+'" lnp="'+n+x3+d+x4+(f?t+'</a>'+x+'d'+y+d+xh+ x2+u+x1+qf+'"u" lnp="'+n+x3+d+x4+r:x+'t'+y+t+xh+x+'d'+y+d+xh+x+'u'+y+r+xh)+'</a></p>')}
...
if(s){z=s.getAttribute("zT");if(z){if(z.indexOf('-o')==0&&(!s.f)){zTiS(s,3);z=z.substring(2,z.length);s.href=zh+gs+'.'+uy+"/gi/o.htm"+zMu(s,z,window.event,1,1);return r}
else if(!s.f){zPxzT(zMu(s,z,window.event,1),35);return r}}
...
if(s.lnp)zPxT('glnp='+s.lnp+'&gs='+gs+'&t='+zTa+'&bt='+zBT+'&bts='+zBTS+zST(2,'&st='));if(o0){x=t.indexOf('zu=');if(x>-1){t=t.substring(x);o0=t.indexOf(uy)==-1}}
else if(o1){t=t.substring(y+17);o1=t.indexOf(uy)==-1}
if(o0||o1||o2)if(t.indexOf(zh)==0){zTiS(s,3);r=1}}else r=s.f}};return r}
...
w((s?s:'Bookmark')+'</a>')}}
function zDM(t,h,n){var v=t==1?2:1,y=v>1?7200:60,c='zDot',d=c+'D';zbDM=v>1
zc(5,c,v,y,'');if(n&&n.length)zc(5,d,n,y+1,'')}
function zDMD(){var v=zc(6,'zDotD');v=';Dt'+(v.length<4?'1000':v)
while(v.indexOf(',')>0)v=zrp(v,',','=1;Dt');return v+'=1'}
function zFUC(){var u,e=window.event.srcElement;if(e){u=e.href;if(u&&u.length&&((u.indexof(uy)<0)||(u.indexof('clk.'+uy)>0))){window.attachEvent("onunload",null)}}}
...
function mN(y){var o="open",m=document.getElementById("m"+y),t=m.className==o?1:0;zc(5,"mn"+y,t,99999,'');m.className=t?"clse":o}
function cF(a,b,y,t,f,c){y=document.getElementById("bID");if(y){t=y.className,f=t.charAt(1),c=t.charAt(2)
if(a>0&&f<3)f++;if(a<0&&f>0)f--;y.className="b"+f+(b>0?1:0)}}
function zE(s,o){return o?unescape(s):escape(s)}
function zUriS(s,r){ try {r=encodeURI(s)} catch(e) {r=escape(s)} return r}
function ztbo(){zTbO=0;zc(5,'zTb',3,60,'')}
function wTb(){var t,s=this.zTBD?zTBD:'23457',a='<td id="f',nw,n,i=0,m,tx=document.createTextNode(" "),c,y='<img src="http://z.about.com/0/js/ftb/'
w(x5+'iTb" onMouseOver="zTbC=1" onMouseOut="zTbC=0">');wt(630,0,'0 id="fTb"',0,0)
wL('<tr>'+a+'1">');wL('<a href="javascript:ztbo()">'+y+'fc03.gif" border=0 alt="Close"/></a>');wL('<a href="'+zh+uy+'/?tb=1" onMouseOver="zH(0,\'iTbm\',1)">'+y+'fl02.gif" alt="About.com" border=0 /></a></td>')
for(z=0;z<s.length;z++){c=s.charAt(z);if(2==c)w(a+'2"><a href="'+zh+'holidays.'+uy+'/?tb=2">Holiday Gifts</a></td>')
if(3==c){if(gEI('rTpE')){zTbE(a+3,'rTpE','te','E-Mail this page to a friend')}else{c=9}}
if(4==c)zTbE(a+4,'rTpr','tp','Print this page')
if(9==c)zTbE(a+3,'rTpB','tb','Bookmark this site')
if(5==c){w(a+'5"></td>');m=gEI('f5');i=0;m.appendChild(tx.cloneNode(1));while((nw=gEI('rTpn'+i++))&&nw.hasChildNodes()&&(nw=nw.firstChild)){m.appendChild(tx.cloneNode(1));m.appendChild(nw.cloneNode(1))}}
if(7==c){if(zc(6,"nl")==1)c=6;else zTbI(a+7,2,'subR','<b>Free</b> Newsletter','su','Enter email address')}
if(6==c)zTbI(a+6,1,'sas','<b>Search</b>','bg','Enter keyword(s)')}
w('</tr></table>')
w(x5+'iTbm" onMouseOut="zTbC=0;zH(16,this,0)" onMouseOver="zTbC=1;zH(16,this,1)">'+x6+x6)
m=gEI('iTbm');i=0;if(m)while(i<zOHA.length){h=document.createElement("a");h.href=zh+uy+"/"+zOHA[i++]+"/?tb=1";h.className="ch";t=document.createTextNode(zOHA[i++]);h.appendChild(t);m.appendChild(h)}}
function zOs(e,t,s){var k=0;if(e)k=window.event?e.keyCode:e.which;if(k==13)t=s;s=gEI("rTpSr"+t)
if(1==t)zOsS(sas,sas.terms,s)
if(2==t)zOsS(subR,subR.email,s)}
function zOF(t){if(!t.c){t.c=1;t.value=''}}
function zOsS(f,o,s){o.value=s.value;f.zi.value=f.zi.value+'/-1';f.submit()}
function zTbI(f,n,u,t,g,d,nw){w(f+'">');if(nw=gEI(u))w(' '+t+' <input id="rTpSr'+n+'" type="text" name="srch" value="'+d+'" onKeyUp="zOs(event,0,'+n+')" onFocus="zOF(this)"/><a href="java'+sc+':zOs(0,'+n+')"><img src="http://z.about.com/f/bt/'+g+'.gif" border=0 /></a>&nbsp; ');w('</td>')}
function zTbE(a,u,g,d,nw){w(a+'">');if(nw=gEI(u)){w('<a href="'+nw.href+'"><img src="http://z.about.com/f/bt/'+g+'.gif" alt="'+d+'" border="0" /></a>')}w('</td>')}
function zH(o,u,a){if(!(o&16))u=gEI(u);o=o&7
if(o==0){u.style.visibility=a?'visible':'hidden';u.style.display=a?'block':'none'}
if(o==1)return u}
function zTb(f,r){return;r=0;f=zc(6,"zTb");if(f=="3")zTbO=0;if(f!="2"){if(zTbO>1)r=1;if(zbI)r=(zbVi<5)||((zbVi<5)&&zbM);if(!gEI('subR'))r=1}
if(r)return;wTb()
var t=this,e;t.x=t.xS=171;t.y=t.yS=0;t.d=document;t.i="iTb";e=gEI(t.i)
if(t.d.layers)e.style=e;t.e=e;e.t=t;t.L=gEI("lg")
t.yH=t.L?gCT(t.L)+t.L.clientHeight-20:60
t.x=t.L?t.L.offsetWidth:171
t.B=gEI("adB")
t.BT=t.B?gCT(t.B):0
t.BB=t.BT?t.BT+t.B.clientHeight:0
if(t.BT)t.BT-=15
mTb(t.i)}
...
function mTb(i){var e=gEI(i),t=e.t,pY=gST(),b,s;t.y+=(pY+t.yS-t.y)/8;b=t.BT&&(t.y>t.BT&&t.y<t.BB);s=t.L&&(t.y>t.yH&&!b);if(zTbO==0)s=0
zH(0,i,s);if(t.s&&!s)zH(0,'iTbm',0)
t.s=s;e.style.left=t.x;e.style.top=t.y
setTimeout('mTb("'+i+'")',10)}
function zBB(p,t,l,i){p=gEI("adT");t=gCT(p)+zBbo;l=gCL(p);w('<div id="adB" style="position:absolute;top:'+t+'px;left:'+l+'px;font-size:11px;color:#666;vertical-align:top;float:none;clear:none;margin:0;border:none">'+ap[0]+at[4]+as[0]);adunit('','',uy,ch,gs,336,280,'1','bb',3);w('</div>')}
...
function zBBaf(b,r,i,s,p,t){r=-1;b=gEI("adB");if(b)r=(gCT(b)+315)<zIfh?1:0
...
function create_modal(a){ 
	...
	if(a.getAttribute('data-type') == "pop" || isIE6) {
		...
		a.onclick = function(){
			return prep_modal(this.getAttribute('data-url'),this.getAttribute('data-modclass'),this.getAttribute('data-type'),this.getAttribute('data-uclick'));
		}
	}
}
...
function prep_modal(url,c,t,u){
	if(!url) return;
	if(u){
		var i=new Image();i.src='http://clk.about.com?zi='+u+'&sdn='+gs+'&cdn='+ch+'&tt=39&bt=0&bts=1';
	}
	if(t == 'pop') {
		zpu(0,url,(w)?w:404,(h)?h:300,"modal");
	} else {
		//create background to put behind modal (normally styled as translucent)
		var o = createOverlay(c);
		...
		d.style.top = ((zIfh/2)-((d.clientHeight+2)/2))+"px";
		...
		if(c!='downtime') o.onclick = function(){hide_modal()};
		if(c!='downtime') addEventSimple(window,'keypress',esc_hide_modal);
		return false;
	}
}
...
function frameLoad(i,r,c){
	...
	if(r) s = i.contentWindow.document.getElementsByTagName("dl"); //this is for the rotate script to work properly
...
function setFrameHeight(i,c) { //resize modal frame to fit iframe content and centers frame in the viewport
	...
	if(c){
		i.parentNode.style.left = ((zIfw/2)-((i.clientWidth+2)/2))+"px";
		i.parentNode.style.top = ((zIfh/2)-((i.clientHeight+2)/2))+"px";
	}
}

function esc_hide_modal(e){ //hitting escape closes modal window
	var kC  = (window.event)?event.keyCode:e.keyCode;
	var Esc = (window.event)?27:e.DOM_VK_ESCAPE;
	if(kC==Esc){if(parent.frames['modf']){parent.hide_modal();}else{hide_modal();}}
}
...
function hide_modal(i){ //clean-up time
	...
	removeEventSimple(window,'keypress',esc_hide_modal);
}
...
/* Dyamically switches the facebook like button from a static image to an iframe. This will only be invoked the first time a user clicks on the static image (and agrees to use the like button) */
function fbl_on() {
	createCookie('fbl',1);
	setTimeout("gEI('fbl').innerHTML = '<iframe src=\"http://www.facebook.com/plugins/like.php?href=http://'+gs+'.about.com/&amp;layout=button_count&amp;show_faces=false&amp;font=verdana\" scrolling=\"no\" frameborder=\"0\" allowTransparency=\"true\" ref=\"content\" onload=\"frameLoad(this);\"></iframe>'",500);
}

/* create a hint bubble that pops-up to focus the user's attention & give them instructions. */
function hint(string,container,id){
...
function yt(){
	var a = gEI('articlebody').getElementsByTagName('a');
	for(var i=0;i < a.length;i++) {
		if(a[i].href.indexOf('.youtube.com/watch?v')>0){
			var l = unescape(a[i].href);
			var x = l.indexOf('v=');
			var y = l.indexOf('&',x);
			var id = (y>0)?l.substring(x+2,y):l.substring(x+2);
			a[i].href = 'http://www.about.com/gi/pages/yt.htm?vid='+id;
			a[i].className = 'yt';
			create_modal(a[i]);
		}
	}
...
/*var sb = gEI('widgets');
var sbop = findPos(sb);
var sbc = (gEI('articlebody').offsetHeight+findPos(gEI('articlebody'))[1]);
sb.style.position = "fixed";
sb.style.top = sbop[1]+3+"px";
sb.style.left = sbop[0]+"px";
var sw = window.setInterval(function(){
	if(winHeight > sidebarHeight){
		...
		function updateSidebar(){		
			...
			var sidebarHeight = sb.offsetHeight;
			var sidebarPos = findPos(sb);
	
		
			if(winScroll >= sbop[1] && (winScroll+sbop[1]) < sbc){
				sb.style.top = 0;
			} else if(winScroll+sbop[1] >= sbc) {
				sb.style.top = -((winScroll+sbop[1])-sbc)+"px";
			} else {
				sb.style.top = (sbop[1]-winScroll)+3+"px";
			}
		}
		
		updateSidebar();
		Event.observe(window, 'scroll', updateSidebar);
	}
},100);*/
